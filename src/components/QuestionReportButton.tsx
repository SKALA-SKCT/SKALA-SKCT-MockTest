...
export default function QuestionReportButton({ examId, questionId }: { examId: number; questionId: number }) {
  ...
  return <>
    <button type="button" onClick={() => setOpen(true)} className="rounded-md border border-zinc-200 bg-white px-2 py-1 text-[11px] font-semibold text-zinc-500 transition hover:border-red-200 hover:text-red-600">⚑ 신고</button>
