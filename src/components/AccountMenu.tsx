        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/35 px-4">
          <div className="w-full max-w-sm rounded-2xl border border-zinc-200 bg-white p-6 shadow-2xl">
            <div className="space-y-2">
              <p className="text-lg font-bold text-zinc-950">회원탈퇴</p>
            ...
            <div className="mt-5">
              ...
              <input
                ...
                autoComplete="off"
                disabled={busy}
                className="mt-2 w-full rounded-lg border border-zinc-300 px-4 py-2.5 text-sm outline-none focus:border-red-500 disabled:bg-zinc-50 disabled:text-zinc-400"
              />
              {deleteError && (
            ...
            <div className="mt-6 flex justify-end gap-2">
              <button
                ...
                disabled={busy}
                className="rounded-lg border border-zinc-200 px-4 py-2 text-sm font-semibold text-zinc-600 hover:bg-zinc-50 disabled:opacity-50"
              >
                취소
              </button>
              <button
